...
- [ ] 3.2 `review.php` — система отзывов (AJAX)
- [ ] 3.3 `report.php` — система жалоб (AJAX)
- [ ] 3.4 Сортировка и фильтры в каталоге
- [ ] 3.5 График онлайна на странице сервера (Chart.js)
- [ ] 3.6 `cron/reset_monthly.php` — сброс месячных голосов
- [ ] 3.7 `cron/cleanup_stats.php` — очистка старых записей
